...
try:
    ...
    dataset = gdal.Open(r"C:\Users\Tomas\Desktop\skola\4_semestr\programovani\cvicna_data")
except RuntimeError:
...
dsOut = driver.Create(r"C:\Users\Tomas\Desktop\skola\4_semestr\programovani\cvicna_data\teren2.tiff", sloupce, radky, 1, gdal.GDT_Float32)
